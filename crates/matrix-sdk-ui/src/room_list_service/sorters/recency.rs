...
/// i.e. by comparing their [`RoomInfo::latest_event`]'s timestamp value, or
...
/// [`RoomInfo::latest_event`]: matrix_sdk_base::RoomInfo::latest_event
...
/// Extract the recency _scores_ from either the [`RoomInfo::latest_event`]
